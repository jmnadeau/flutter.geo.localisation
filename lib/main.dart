        ...
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
                ...
                child: Text('Position courante')
            ),
            ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const IntervalPage()),
                  );
                },
                child: Text('Envoyer la position avec un intervalle')
            ),
            ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const DistancePage()),
                  );
                },
